  ...
  static Uint8List appendUpdates(
    ...
    for (final run in runs) {
      ...
      for (final id in run) {
        ...
        // ── Exactly 20 bytes: 10-digit offset, space, 5-digit generation,
        //    space, type char, \r\n. The spec (PDF 32000-1, Table 17)
        //    requires this fixed width. Any extra byte here breaks readers
        //    that assume 20-byte alignment — every entry after the first
        //    is read at the wrong offset and the page becomes unreachable.
