  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          _header('DocScanSign Privacy Policy'),
          _meta('Last updated: April 2026'),
          const SizedBox(height: 24),

          _section('1. Overview',
              'DocScanSign is a 100% offline document annotation, signing, and scanning app. '
          ...
          _section('3. Camera & Photo Library',
              'DocScanSign requests camera and photo library access only when you use the '
          ...
          _section('4. File Access',
              'DocScanSign reads PDF and document files only when you explicitly open them '
              'using the "Open PDF" or "Open Document" features. Files are never '
              'transmitted off your device.'),

          _section('5. Internet',
              'DocScanSign may use internet access to download Google Fonts on first launch '
          ...
          _section('6. Third-Party Services',
              'DocScanSign uses the following open-source packages, all of which operate '
              'entirely offline:\n'
              '• pdfx — PDF rendering\n'
              '• pdf — PDF generation\n'
          ...
          _section('7. Data Retention',
              ...
              'You can delete all app data at any time by uninstalling DocScanSign or '
              'clearing app data in your device settings.'),

          _section('8. Children\'s Privacy',
              'DocScanSign does not knowingly collect any information from children under 13. '
