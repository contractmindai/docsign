        ...
        children: [
          ...
          Row(
            children: [
              ...
              const Text('DocScanSign', style: TextStyle(color: Colors.white, fontSize: 18, fontWeight: FontWeight.w700)),
            ],
          ),
          const Spacer(),
          if (isWide) ...[
      ...
      child: Column(
        children: [
          ...
          Text('Need AI-powered contract management?',
              ...
              textAlign: TextAlign.center),
          const SizedBox(height: 16),
          const Text('ContractMind adds AI intelligence on top of DocScanSign — automated workflows, team collaboration, and analytics.',
          ...
          Wrap(
            ...
            children: [
              ...
              OutlinedButton(
                ...
                child: const Text('Use DocScanSign Free →', style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600)),
              ),
            ],
          ),
        ],
        ...
        children: [
          const Row(
            ...
            children: [
              ...
              SizedBox(width: 8),
              Text('DocScanSign', style: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w700)),
            ],
          ),
          const SizedBox(height: 12),
          Text('© 2026 DocScanSign by ContractMind. 100% offline PDF tools.',
